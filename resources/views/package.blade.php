...
<div class="container-xxl py-5">
    <div class="container">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="package-item">
                    <div class="overflow-hidden">
                        <!-- تحميل الصور ديناميكيًا من قاعدة البيانات -->
                    ...
                    <div class="text-center p-4">
                        ...
                        <div class="mb-3">
                            @for ($i = 0; $i < 5; $i++)  <!-- عرض النجوم -->
                                <small class="fa fa-star {{ $i < $package->rating ? 'text-primary' : 'text-muted' }}"></small>
                            @endfor
                        </div>
                        <p>{{ $package->description }}</p>
                        <div class="d-flex justify-content-center mb-2">
                            <a href="{{ route('detailspackages', $package->id) }}" class="btn btn-sm btn-primary px-3 border-end" style="border-radius: 30px 0 0 30px;">Read More</a>
                            <a href="{{ route('booking', $package->id) }}" class="btn btn-sm btn-primary px-3" style="border-radius: 0 30px 30px 0;">Book Now</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-center mt-4">
            {{ $packages->links() }}  <!-- عرض روابط التصفح -->
        </div>
    </div>
</div>
<!-- Package End -->
